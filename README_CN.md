...
| `reviewer` | `codex` | 审稿后端：`codex`（GPT-5.6-Sol xhigh，默认）、`oracle-pro`（GPT-5.5 Pro via [Oracle](https://github.com/steipete/oracle)） |
