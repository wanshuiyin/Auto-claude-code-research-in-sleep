...
📰 **ARIS-Code v0.4.20** (2026-06) — latest is a **bug-fix patch**: 7 user-facing fixes from a Codex adversarial hunt — short REPL replies no longer vanish behind "✔ Done" ([#299](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep/issues/299)), streamed multi-paragraph replies no longer render glued, CJK/fullwidth tables align, `aris "prompt"` honors your saved executor model, Esc closes the completion menu, and more. The headline features remain **v0.4.18 — default model Claude Opus 4.8** (with corrected pricing — current Opus/Sonnet had been over-billed up to 5× — and an availability fallback so the bump can't break accounts without 4.8 access) and **v0.4.17 — the MCP release**: user-configured `mcpServers` drive real tool dispatch, and **cross-model adversarial review needs no OpenAI API key** (`aris setup` wires your **ChatGPT subscription** in as the reviewer via *Codex MCP* in one step). Caps a 16-release polish run (v0.4.5 → v0.4.20) — full per-release detail below. Credits: [@GetIT-Sunday](https://github.com/GetIT-Sunday), [@Anduin9527](https://github.com/Anduin9527), [@GO-player-hhy](https://github.com/GO-player-hhy), [@Jxy-yxJ](https://github.com/Jxy-yxJ), [@screw-44](https://github.com/screw-44), [@StevenUST](https://github.com/StevenUST), [@opposj](https://github.com/opposj), [@ShijunLei-cn](https://github.com/ShijunLei-cn), [@algojogacor](https://github.com/algojogacor).
