...
6. **Cross-model independence.** Per-page Codex calls in `/slides-polish` use fresh threads (no `reviewer-continuation`). See `../shared-references/reviewer-independence.md`.
