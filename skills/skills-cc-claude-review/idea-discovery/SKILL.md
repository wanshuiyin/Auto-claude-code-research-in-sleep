...
- Brainstorm 8-12 concrete ideas via Claude reviewer
...
- Cross-verify with Claude reviewer
...
**What this does:**
- Claude reviewer acts as a senior reviewer (NeurIPS/ICML level)
...
- Iteratively refine the method via Claude reviewer review (up to 5 rounds, until score ≥ 9)
