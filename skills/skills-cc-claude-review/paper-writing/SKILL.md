...
- Claude reviewer reviews the plan for completeness
...
- Claude reviewer reviews figure quality and captions
...
- Claude reviewer reviews each section for quality
...
**Round 1:** Claude reviewer reviews the full paper → identifies CRITICAL/MAJOR/MINOR issues → Claude Code implements fixes → recompile → save `main_round1.pdf`

**Round 2:** Claude reviewer re-reviews with conversation context → identifies remaining issues → Claude Code implements fixes → recompile → save `main_round2.pdf`
