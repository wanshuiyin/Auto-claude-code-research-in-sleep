...
allowed-tools: Bash(*), Read, Write, Edit, Grep, Glob, Agent, mcp__claude-review__review_start, mcp__claude-review__review_reply_start, mcp__claude-review__review_status, WebSearch
---
