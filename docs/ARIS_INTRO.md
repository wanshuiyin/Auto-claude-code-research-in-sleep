...
ARIS（**A**utonomous **R**esearch via Adversarial **M**ulti-Agent Collaboration，**梦中科研**）是一组 76 个可组合的 Claude Code skills，编排**跨模型对抗式协作**：
